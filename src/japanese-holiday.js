  ...
  const getHolidayName = function (date) {
    ...
    if (new Date("1973/04/12") <= date && date <= new Date("2006/12/31")) {
      ...
      if (
        ...
        _getPublicHolidayName(previousDate) !== ""
      ) {
        holidayName = "振替休日";
      }
    }
    ...
    if (new Date("1985/12/27") <= date) {
      if (
        _getPublicHolidayName(previousDate) !== "" &&
        _getPublicHolidayName(nextDate) !== "" &&
        weekday >= 2 &&
        weekday <= 6
      ) {
        holidayName = "国民の休日";
  ...
  const _getPublicHolidayName = function (date) {
    ...
    if (1900 <= year && year < 1980) {
      if (month === 3) {
        if (
          day ===
          parseInt(20.8357 + 0.242194 * (year - 1980), 10) -
            parseInt((year - 1983) / 4, 10)
        ) {
      ...
      if (month === 9) {
        if (
          day ===
          parseInt(23.2588 + 0.242194 * (year - 1980), 10) -
            parseInt((year - 1983) / 4, 10)
        ) {
    ...
    if (1980 <= year && year < 2100) {
      if (month === 3) {
        if (
          day ===
          parseInt(20.8431 + 0.242194 * (year - 1980), 10) -
            parseInt((year - 1980) / 4, 10)
        ) {
          publicHolidayName = "春分の日";
        }
      }
      if (month === 9) {
        if (
          day ===
          parseInt(23.2488 + 0.242194 * (year - 1980), 10) -
            parseInt((year - 1980) / 4, 10)
        ) {
          publicHolidayName = "秋分の日";
        }
    ...
    if (2100 <= year && year < 2150) {
      if (month === 3) {
        if (
          day ===
          parseInt(20.851 + 0.242194 * (year - 1980), 10) -
            parseInt((year - 1980) / 4, 10)
        ) {
          publicHolidayName = "春分の日";
        }
      ...
      if (month === 9) {
        if (
          day ===
          parseInt(24.2488 + 0.242194 * (year - 1980), 10) -
            parseInt((year - 1980) / 4, 10)
        ) {
          publicHolidayName = "秋分の日";
        }
